...
<section class="bg-color-azure pd-30">
	<div class="container">
		<div class="center-xs bg-color-azure pd-30">
			<h3><?php the_field( 'believe_about-us_title' ); ?></h3>
			<p><?php the_field( 'believe_about-us_desc' ); ?></p>
		</div>

		<div class="row row-xs-2 row-sm-4 row-md-6 bg-color-mintcream pd-30">
	...
	<div class="container">
		...
		<div class="row row-xs-2 row-md-4 bg-color-mintcream pd-30">
