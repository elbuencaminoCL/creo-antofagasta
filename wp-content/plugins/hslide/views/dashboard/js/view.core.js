...
jQuery(function(){
	...
	//reset map markers object
	if(typeof map_markers_object !== 'undefined'){
		map_markers_object = undefined;
	}
	//check woo
	check_woo();
});
...
function check_woo(){
	...
	jQuery.ajax({
		...
		if(global_woo_check){
			jQuery('.woo_checker').html('<img src="'+plugin_url+'assets/images/admin/woo_2.jpg">');
		} else {
			jQuery('.woo_checker').html('<img src="'+plugin_url+'assets/images/admin/woo_1.jpg">');
		}
	}).fail(function(event){
		//page error		
	});
